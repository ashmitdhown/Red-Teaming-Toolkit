...
const INITIAL_IMAGE_ATTACKS: Attack[] = [
  // ── Control ──────────────────────────────────────────────────────────────
  { id: '1',  name: 'Baseline (control)',       category: 'Control',                  payload: 'Uploaded image (or auto-generated 224×224)',      expectedResult: 'valid label (~1.0)',              defendedStatus: 'N/A (control)', status: 'IDLE', imageTransform: 'baseline'           },
  // ── Malformed ─────────────────────────────────────────────────────────────
  { id: '2',  name: 'Non-image file',           category: 'Malformed',                payload: 'Text bytes sent with .jpg extension',            expectedResult: '400 not a valid image',           defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'non-image'          },
  { id: '3',  name: 'Zero-byte file',           category: 'Malformed',                payload: 'Empty 0-byte file',                              expectedResult: '400 file is empty',               defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'zero-byte'          },
  { id: '4',  name: 'Truncated JPEG',           category: 'Malformed',                payload: 'First 100 bytes of a valid JPEG only',           expectedResult: '400 not a valid image',           defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'truncated'          },
  { id: '5',  name: '10 MB junk file',          category: 'Malformed',                payload: '10 MB of byte 0x41 ("A") with .jpg extension',  expectedResult: '400 not a valid image',           defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'oversized-junk'     },
  // ── Boundary / Type ───────────────────────────────────────────────────────
  { id: '6',  name: 'Missing file field',       category: 'Boundary / Type',          payload: 'Empty POST body — no file field',                expectedResult: '422 field required',              defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'missing-field'      },
  { id: '7',  name: 'Wrong field name',         category: 'Boundary / Type',          payload: 'File sent as "image=" instead of "file="',       expectedResult: '422 field required',              defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'wrong-field'        },
  // ── Adversarial: JPEG compression ─────────────────────────────────────────
  { id: '8',  name: 'JPEG compression q=50',   category: 'Adversarial perturbation', payload: 'Recompressed JPEG (quality=0.50)',                expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'jpeg-q50'           },
  { id: '9',  name: 'JPEG compression q=20',   category: 'Adversarial perturbation', payload: 'Recompressed JPEG (quality=0.20)',                expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'jpeg-q20'           },
  { id: '10', name: 'JPEG compression q=10',   category: 'Adversarial perturbation', payload: 'Recompressed JPEG (quality=0.10)',                expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'jpeg-q10'           },
  { id: '11', name: 'JPEG compression q=5',    category: 'Adversarial perturbation', payload: 'Recompressed JPEG (quality=0.05)',                expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'jpeg-q5'            },
  { id: '12', name: 'JPEG compression q=1',    category: 'Adversarial perturbation', payload: 'Recompressed JPEG (quality=0.01)',                expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'jpeg-q1'            },
  // ── Adversarial: Rotation ─────────────────────────────────────────────────
  { id: '13', name: 'Rotation 5°',             category: 'Adversarial perturbation', payload: 'Image rotated 5° clockwise',                     expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'rotate-5'           },
  { id: '14', name: 'Rotation 90°',            category: 'Adversarial perturbation', payload: 'Image rotated 90° clockwise',                    expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'rotate-90'          },
  // ── Adversarial: Brightness ───────────────────────────────────────────────
  { id: '15', name: 'Brightness ×0.3',         category: 'Adversarial perturbation', payload: 'Image darkened (factor=0.3)',                     expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'brightness-0.3'     },
  { id: '16', name: 'Brightness ×0.5',         category: 'Adversarial perturbation', payload: 'Image darkened (factor=0.5)',                     expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'brightness-0.5'     },
  { id: '17', name: 'Brightness ×0.7',         category: 'Adversarial perturbation', payload: 'Image darkened (factor=0.7)',                     expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'brightness-0.7'     },
  { id: '18', name: 'Brightness ×1.3',         category: 'Adversarial perturbation', payload: 'Image brightened (factor=1.3)',                   expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'brightness-1.3'     },
  { id: '19', name: 'RGB→BGR channel swap',    category: 'Adversarial perturbation', payload: 'R and B channels swapped',                       expectedResult: 'stable label (Defended)',          defendedStatus: 'Defended',      status: 'IDLE', imageTransform: 'channel-swap'       },
  // ── Boundary: silent-acceptance attacks ───────────────────────────────────
  { id: '20', name: 'Wrong content-type',      category: 'Malformed',                payload: 'Valid JPEG bytes sent as text/plain',            expectedResult: 'Accepted anyway (NOT Defended)',  defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'wrong-content-type' },
  { id: '21', name: 'Multiple files',          category: 'Boundary / Type',          payload: 'Two files in one multipart field',               expectedResult: 'Uses last file silently',          defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'multiple-files'     },
  // ── Adversarial: Gaussian noise ───────────────────────────────────────────
  { id: '22', name: 'Gaussian noise σ=5',      category: 'Adversarial perturbation', payload: 'Imperceptible Gaussian noise (σ=5)',              expectedResult: 'label shift possible',             defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'noise-5'            },
  { id: '23', name: 'Gaussian noise σ=10',     category: 'Adversarial perturbation', payload: 'Small Gaussian noise (σ=10)',                    expectedResult: 'label shift',                     defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'noise-10'           },
  { id: '24', name: 'Gaussian noise σ=20',     category: 'Adversarial perturbation', payload: 'Medium Gaussian noise (σ=20)',                   expectedResult: 'significant label change',         defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'noise-20'           },
  { id: '25', name: 'Gaussian noise σ=40',     category: 'Adversarial perturbation', payload: 'Large Gaussian noise (σ=40)',                    expectedResult: 'major label shift',               defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'noise-40'           },
  { id: '26', name: 'Gaussian noise σ=80',     category: 'Adversarial perturbation', payload: 'Very large Gaussian noise (σ=80)',               expectedResult: 'heavy label shift',               defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'noise-80'           },
  // ── Adversarial: Rotation (higher) ───────────────────────────────────────
  { id: '27', name: 'Rotation 15°',            category: 'Adversarial perturbation', payload: 'Image rotated 15°',                              expectedResult: 'label change likely',              defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'rotate-15'          },
  { id: '28', name: 'Rotation 45°',            category: 'Adversarial perturbation', payload: 'Image rotated 45°',                              expectedResult: 'label change',                    defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'rotate-45'          },
  // ── Adversarial: Brightness (overexposure) ────────────────────────────────
  { id: '29', name: 'Brightness ×1.5',         category: 'Adversarial perturbation', payload: 'Overexposed (factor=1.5)',                        expectedResult: 'label shift',                     defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'brightness-1.5'     },
  { id: '30', name: 'Brightness ×2.0',         category: 'Adversarial perturbation', payload: 'Heavily overexposed (factor=2.0)',                expectedResult: 'label shift',                     defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'brightness-2.0'     },
  // ── DoS ───────────────────────────────────────────────────────────────────
  { id: '31', name: 'Decompression bomb',      category: 'DoS',                      payload: '4096×4096 solid PNG (~64 MB uncompressed)',      expectedResult: 'HTTP 500/502 crash',              defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'decompression-bomb' },
  // ── Calibration ───────────────────────────────────────────────────────────
  { id: '32', name: 'Calibration collapse',    category: 'Adversarial perturbation', payload: 'Pure random noise image (all inputs)',            expectedResult: 'confidence < 0.1',                defendedStatus: 'NOT Defended',  status: 'IDLE', imageTransform: 'calibration'        },
];
